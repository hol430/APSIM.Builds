<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Upload.aspx.cs" Inherits="APSIM.Builds.Portal.Upload" %>
...
&nbsp;&nbsp; Password:
    ...
    <p>
       Task ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <asp:DropDownList ID="BugList" runat="server" DataTextField="Description" 
